          ...
          <nav
            ...
            <div id="hs-navbar-floating-dark"
              ...
              <div className="flex flex-col md:flex-row md:items-center md:justify-end py-3 md:py-0 md:ps-7">
                <a className="p-4 ps-px sm:px-3 md:py-4 text-sm text-white hover:text-neutral-300 focus:outline-none focus:text-neutral-300"
                  href="/product/">製品</a>
                <a className="p-4 ps-px sm:px-3 md:py-4 text-sm text-white hover:text-neutral-300 focus:outline-none focus:text-neutral-300"
                ...
                <div>
                  <a className="ml-2 inline-flex items-center gap-x-2 py-2 px-4 bg-[#ff0] font-medium text-sm text-neutral-800 rounded-full focus:outline-none"
                    href="#">
                    サインイン
                  </a>
                </div>
              ...
              <div className="py-8 lg:py-16 lg:pe-16">
                ...
                <div className="mt-8 grid grid-cols-1 gap-8 sm:grid-cols-3">
                  <div>
                    ...
                    <ul className="mt-6 space-y-4 text-sm">
                      <li>
                        <a id="product_list_1" href="#"
                          className="text-gray-700 transition hover:opacity-75"></a>
                      </li>
                      <li>
                        <a id="product_list_2" href="#"
                          className="text-gray-700 transition hover:opacity-75"></a>
                      </li>
                      <li>
                        <a id="product_list_3" href="#"
                          className="text-gray-700 transition hover:opacity-75"></a>
                      </li>
                      <li>
                        <a id="product_list_4" href="#"
                          className="text-gray-700 transition hover:opacity-75"></a>
                      </li>
                      <li>
                        <a id="product_list_5" href="#"
                          className="text-gray-700 transition hover:opacity-75"></a>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div>
                    ...
                    <ul className="mt-6 space-y-4 text-sm">
                      <li>
                        <a href="/about_site/"
                          className="text-gray-700 transition hover:opacity-75">このサイトについて</a>
                      </li>

                      <li>
                        <a href="/terms_of_service/"
                          className="text-gray-700 transition hover:opacity-75">利用規約</a>
                      </li>

                      <li>
                        <a href="/member/star_dot123/"
                          className="text-gray-700 transition hover:opacity-75">管理者のプロフィール</a>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div>
                    ...
                    <ul className="mt-6 space-y-4 text-sm">
                      <li>
                        <a href="/contact_us/" className="text-gray-700 transition hover:opacity-75">お問い合わせ</a>
                      </li>

                      <li>
                        <a href="/question/" className="text-gray-700 transition hover:opacity-75">よくある質問</a>
                      </li>

                      <li>
                        <a href="https://youtube.com/@stardot_dev"
                          className="text-gray-700 transition hover:opacity-75">YouTube</a>
                      </li>

                      <li>
                        <a href="https://github.com/Stardot-dev"
                          className="text-gray-700 transition hover:opacity-75">GitHub</a>
                      </li>
                    </ul>
                  </div>
                </div>
                ...
                <div className="mt-8 border-t border-gray-100 pt-8">
                  <ul className="flex flex-wrap gap-4 text-xs">
                    <li>
                      <a href="/terms_of_service/" className="text-gray-500 transition hover:opacity-75">利用規約</a>
                    </li>

                    <li>
                      <a href="/privacy_policy/"
                        className="text-gray-500 transition hover:opacity-75">プライバシー・ポリシー</a>
                    </li>

                    <li>
                      <a href="/use_cookie/" className="text-gray-500 transition hover:opacity-75">クッキーの使用について</a>
                    </li>
                  </ul>

                  <p className="mt-8 text-xs text-gray-500">&copy; <span id="cc_year"></span>. Stardot.</p>
                </div>
              </div>
            </div>
          </div>
